...
\Cref{fig:example} shows all three on two systems at a single sample size and
noise level: the certified interval for every candidate generator, the tolerance
it is compared against, and the resulting count of certified generators.
